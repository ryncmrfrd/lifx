if(typeof(Storage)!=="undefined"){if(localStorage.getItem('lifxAuthKey')){window.location.href='app'}}
...
else{localStorage.setItem('lifxAuthKey',val);window.location.href='app'}}